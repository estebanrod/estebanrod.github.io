...
La **Asamblea Cristiana de Madrid** abre un local en la **calle Zazuar 13, en el barrio de Santa Eugenia (Vallecas)**, con la intención de abrirse al barrio para evangelizar siguiendo el modelo de iglesia celular del curso LIDERE.

**Santa Eugenia** es un barrio con identidad propia dentro del distrito de Villa de Vallecas. Características relevantes para la propuesta:

- **Barrio obrero y popular**, con fuerte sentido de comunidad vecinal.
- **Multicultural**: alta presencia de población latina, china, magrebí, rumana, subsahariana. El evangelio transcultural encaja perfectamente.
- **Joven y familiar**: muchas familias con hijos, jóvenes buscando referentes.
- **Identidad vallecana**: orgullo de barrio, cultura de calle, asociacionismo, movimiento vecinal fuerte. No funciona lo que suene a "franquicia" o a algo impuesto desde fuera.
- **Necesidades reales**: desempleo, soledad, exclusión social, familias rotas. El mensaje de restauración y comunidad tiene un suelo fértil.

**Principios de la visión LIDERE aplicados al nombre:**

- **Visión** (Ap 7:9 + Is 61:4): *"Llenar el cielo y transformar el mundo"*. El nombre debe comunicar tanto alcance (ganar personas) como transformación (impacto social en el barrio).
- **Misión** (Mt 22 + Mt 28): Hacer discípulos que aman a Dios, aman al prójimo y se reproducen en otros. Un discípulo sin una de estas tres patas *"es como una banqueta quebrada"*.
- **Estrategia** (Hechos 2:42-47): Vida compartida en las casas, cada día, con sencillez de corazón, y Dios añadía. *"No es que la iglesia de Dios tenga una misión, sino que la misión de Dios tiene una iglesia."*
- **Valores**: evangelismo por amistad, todos lideramos y servimos (*"ministramos por quiénes somos, no por los dones"*), relaciones saludables, excelencia, comunidad, servicio, generosidad.
- **Las 6C de la célula**: Celebramos, Conectamos, Compartimos, Crecemos, Cuidamos, Conquistamos.
- **CAFÉ pastoral** (Lección 3.3): Compartir + Amor + Fe + Edificar — los primeros pasos en el cuidado de cada persona.
- **Evangelismo relacional** (Lecciones 3.1-3.2): *"Come, celebra, toma un café, comparte actividades de ocio. Sé intencional."* Test del nombre: ¿un miembro puede decir "¿te vienes a [nombre]?" sin que suene a iglesia?
- **Multiplicación** (Lección 4.3): *"Reproducirnos en otro discípulo le llamamos multiplicación"* (2 Ti 2:2 — cuatro generaciones). El nombre debe ser replicable a otros locales y ciudades.
- **Célula** = *"un grupo de amigos con una misión"*. Sin misión, la célula se desenfoca. La misión no es la amistad ni la celebración — es hacer discípulos. Lo demás es fruto.
...
| **Riesgo** | Puede confundirse con un centro social municipal. Necesita eslogan que dé pista espiritual. |
...
- Paleta: tonos cálidos (naranja, crema, marrón claro) que evoquen hogar.

---

### 1.2 La Casa de Zazuar
...
| **Riesgo** | Menor alcance geográfico: quien no conoce la calle Zazuar no conecta. |
...
| **Riesgo** | Algo abstracto para un barrio directo como Vallecas. |
...
| **Riesgo** | Existe una asociación "Puente de Vallecas" y el propio distrito colindante. Puede haber confusión. |
...
| **Riesgo** | Puede sonar a coworking o empresa tech. Poco "de barrio" para Vallecas. |
...
## 2. NOMBRES CON ENFOQUE EN VIDA Y TRANSFORMACIÓN

### 2.1 Vida Nueva Santa Eugenia
...
| **Riesgo** | Suena más explícitamente cristiano, lo que puede ser barrera para algunos y puerta para otros. |
...
| **Riesgo** | Alguna asociación con reformas/decoración, pero el eslogan lo resuelve. |
...
| **Riesgo** | Puede evocar restauración de muebles/arte. El contexto y eslogan lo aclaran. |
...
| **Riesgo** | Puede sonar a academia o programa de empleo. |
...
| **Riesgo** | Puede sonar a tienda ecológica. |
...
| **Riesgo** | Poco conocido como nombre de espacio. |
...
## 3. NOMBRES CON ENFOQUE EN RELACIONES Y AMISTAD
...
| **Riesgo** | Puede sonar a bar/restaurante. Pero en el modelo LIDERE eso no es un problema, es una ventaja (la gente entra). |
...
- Colores: naranja cálido y blanco. Acento en color burdeos (como el vino que se comparte).
...
| **Riesgo** | Puede confundirse con comedor social. El diseño y comunicación deben transmitir dignidad, no caridad. |
...
- Tipografía: serif cálida, con personalidad.
...
| **Riesgo** | Puede sonar imperativo. El diseño debe transmitir invitación, no orden. |
...
- Colores: amarillo vibrante (luz, llamada de atención) sobre fondo oscuro (contraste urbano).
...
| **Riesgo** | Genérico. Necesita buena imagen para diferenciarse. |
...
| **Riesgo** | Existe la ONG "Puertas Abiertas" (persecución cristiana). Confusión probable. **Desaconsejado por esta razón.** |

---

## 4. NOMBRES CON ENFOQUE EN LUZ, ESPERANZA Y BUENAS NOTICIAS

### 4.1 Buenas Noticias Santa Eugenia
...
| **Riesgo** | Puede sonar a agencia de comunicación. El contexto de barrio lo resuelve. |
...
| **Riesgo** | Nombre usado por varias iglesias y organizaciones. Poco original. |
...
| **Riesgo** | También es nombre de persona y de partido político. Posible confusión. |
...
| **Riesgo** | Puede evocar barbacoa o chimenea. Pero eso tampoco es malo en Vallecas. |
...
| **Riesgo** | Nombre usado por bastantes iglesias. |
...
| **Riesgo** | Nombre de discotecas, hoteles, centros comerciales. El diseño debe diferenciarlo claramente. |
...
## 5. NOMBRES CON ENFOQUE EN EL BARRIO Y LO LOCAL
...
| **Riesgo** | No dice nada por sí solo. Necesita comunicación fuerte detrás. Puede sonar a pub. |
...
| **Riesgo** | Suena a plataforma vecinal o movimiento político. Hay que gestionarlo. |
...
| **Riesgo** | Demasiado genérico. Difícil de buscar en Google. |
| **Eslogan** | *"El local de Santa Eugenia"* |

---

### 5.4 Centro Abierto Santa Eugenia
...
| **Riesgo** | Suena institucional, como recurso municipal. Poco alma. |

---

## 6. NOMBRES CON TONO ESPIRITUAL SUTIL
...
| **Riesgo** | Nombre de persona. Puede confundir. |
...
| **Riesgo** | Puede sonar a tienda esotérica o centro de meditación no cristiano. |
...
| **Riesgo** | La mayoría del barrio no sabe qué significa. Barrera lingüística. |
...
| **Riesgo** | Nombre de muchos restaurantes y bares. |
...
## 7. NOMBRES CON VERBOS DE ACCIÓN

### 7.1 Transforma Santa Eugenia
...
| **Riesgo** | Puede sonar político en un barrio con mucho activismo. |
...
| **Riesgo** | Puede sonar a academia de negocios o marketing multinivel. |
...
| **Riesgo** | Puede sonar a operadora de telefonía o coworking. |
...
## 8. COMBINACIONES CREATIVAS

### 8.1 13Once (Trece-Once)
...
| **Riesgo** | Puede sonar a programa municipal o inmobiliario. |
...
| **Ventaja** | Honra la identidad de la iglesia madre (Asamblea Cristiana de Madrid) sin sonar a "templo". "Voy a La Asamblea" suena natural en Vallecas, como ir a una reunión vecinal. Conecta con Hechos 2: la primera iglesia era literalmente una asamblea. |
...
- **Aplicación**: en la fachada, solo "LA ASAMBLEA" en letras grandes iluminadas. Debajo, en pequeño: "Santa Eugenia". Genera curiosidad: "¿La asamblea de qué?"
...
| **Ventaja** | **Extraordinariamente potente como marca.** Todo junto (YoVoy) funciona como marca, hashtag (#YoVoy), dominio (yovoy.es), handle (@yovoy_se). Es contagioso: si alguien lleva una camiseta que dice "YoVoy", la gente pregunta "¿a dónde?". El nombre ES la invitación. Estilo VIVE Church: corto, directo, bilingüe-friendly, aspiracional. |
...
- **Aplicación**: camisetas negras con "YOVOY" en grande = la gente del barrio pregunta. Stories de Instagram: fondo negro, YOVOY en neón. Stickers para pegatinas urbanas. Pulseras tipo festival.
- **Hashtag nativo**: #YoVoy #YoVoySantaEugenia — cada miembro publica su Story del domingo con el hashtag. Evangelismo digital orgánico.
...
| **Ventaja** | **Nombre de 10.** Suena a marca de lifestyle, a cafetería cool, a proyecto de vida. Cero barrera de entrada. "¿Dónde vas?" — "A Pura Vida". El eslogan está dentro del nombre. En un barrio con dificultades reales (paro, soledad, estrés), decir "pura vida" es contracultural y esperanzador. Encaja perfectamente con el estilo Hillsong/VIVE/Elan: aspiracional, positivo, experiencial. |
...
- **Fotografía**: al estilo Elan/VIVE — fotos de gente real sonriendo, abrazándose, en comunidad. Mucha luz natural, mucho desenfoque. La sensación visual de "esto es pura vida".
- **Merch**: camisetas, tote bags, vasos reutilizables con "PURA VIDA" = publicidad que la gente QUIERE llevar. Es un nombre que funciona como marca de moda.
- **Instagram**: @puravidase (Santa Eugenia) o @puravida.madrid — estilo feed curado con fotos luminosas, frases cortas, reels de momentos de comunidad.
...
| **Ventaja** | Suena a startup, a evento tech, a lugar donde pasan cosas. Funciona en redes sociales internacionales. @meetmadrid es potente. Estilo 121 BCN puro. |
...
- **Nota**: si se elige este nombre, considerar la variante **Meet Santa Eugenia** o **Meet SE** para anclar al barrio. Pero pierde musicalidad.
...
- **Fotografía**: interiores cálidos, sofás, luces cálidas tipo Edison, plantas, libros, café humeante. Atmósfera hygge/acogedora.
- **Aplicación**: la fachada con un rótulo tipo cafetería/galería: "SALA EUGENIA" con una planta en la puerta. El vecino entra por curiosidad.
...
| **Ventaja** | **Nombre original y memorable.** No existe en Google (o casi). Dominio disponible, handles libres. Suena a marca. Tiene la energía del estilo VIVE Church: una palabra que es un grito, una invitación, un movimiento. "¿Dónde vas?" — "¡Alasala!" Funciona como marca sonora. |
...
- **Tipografía**: la simetría de la palabra permite diseños tipo logo-espejo o ambigramas.
- **Aplicación**: funciona increíblemente bien como grito/cántico ("¡A-LA-SA-LA!"), en camisetas, en pegatinas. Es una palabra que se puede corear.
...
| **Ventaja** | **Brillante en múltiples niveles.** (1) Es la dirección real, así que es fácil de encontrar. (2) Para el no creyente suena a espacio industrial/cultural cool tipo "Studio 54" o "Room 237". (3) Para el creyente, Filipenses 4:13 es un guiño poderoso. (4) Funciona como marca: @local413, #local413. (5) Estilo Zazuar 13 (sección 5.1) pero con más profundidad bíblica. Es el estilo 121 BCN llevado a Vallecas: 121 = Salmo 121, Local 4/13 = Filipenses 4:13. |
| **Variante 13/4** | Local 13/4 invierte el orden (calle 13, local 4). Pierde la referencia a Filipenses 4:13 pero gana en lógica de dirección postal. **Se recomienda 4/13 por la resonancia bíblica.** |
...
- **Fachada**: número **4/13** grande en la puerta/pared exterior. Estilo galería de arte o espacio cultural underground. El vecino pasa y ve un número grande. Curiosidad.
- **Easter egg**: en el interior, en alguna pared, Filipenses 4:13 completo escrito grande. Cuando alguien pregunta por el nombre, se le muestra. Momento "wow". Evangelismo orgánico.
- **Merch**: camisetas negras con **4/13** en blanco. Minimalismo. La gente pregunta "¿qué es 4/13?" → conversación sobre la fe.
...
| **Ventaja** | **Ya tiene historia y credibilidad en el barrio.** No es un nombre inventado: es una asociación real con años de trabajo social reconocido. Eso da legitimidad inmediata. "ReCreando" suena a proyecto vivo, a taller, a espacio donde pasan cosas. El gerundio ("-ando") transmite acción continua, no algo estático. El "Re-" transmite segunda oportunidad, restauración, renovación — mensaje central del evangelio. Funciona como invitación: "¿Te vienes a ReCreando?" suena a actividad, a taller, a plan. Pasa el test de evangelismo relacional. |
...
- **Colores**: **naranja cálido** (#E8732A) + **verde esperanza** (#27AE60) + **blanco**. El naranja conecta con la energía, la creatividad y la calidez humana. El verde con la vida nueva, el crecimiento y la restauración. Combinación que evoca tanto acción social como vida espiritual.
- **Alternativa cromática**: mantener los colores que la Asociación ReCreando ya usa (si los tiene), para reforzar la continuidad con la identidad existente.
- **Fotografía**: mezcla de dos mundos — fotos de **acción social** (reparto de alimentos, talleres, asesoramiento, Kids Games) junto a fotos de **vida de comunidad** (celebración, grupos, alabanza, bautizos). El mensaje visual es: aquí servimos Y adoramos, aquí cuidamos Y crecemos.
- **Fachada**: "RECREANDO" en letras grandes con el RE en color acento. Debajo: "comunidad · fe · acción social" o simplemente "Santa Eugenia". El vecino que ya conoce la asociación se siente en casa. El que no, entra por curiosidad.
- **Aplicación digital**: @recreando.se (Santa Eugenia) o @recreando.madrid. El nombre funciona muy bien como hashtag: #ReCreando, #ReCreandoVidas, #ReCreandoElBarrio.
- **Ventaja estratégica**: si la Asociación ReCreando ya tiene presencia legal, web (asociacionrecreando.org) y reconocimiento institucional, usar el mismo nombre para el local **unifica marca** y multiplica el impacto. El local es el hogar físico de todo lo que ReCreando ya hace + la dimensión de iglesia.

---

## 10. GUÍA DE IDENTIDAD VISUAL, REFERENCIAS DE ESTILO Y FUNDAMENTO LIDERE

Este apartado unifica tres fuentes para definir la identidad visual del nuevo local: **(1)** los principios y vocabulario del **curso LIDERE** (que es el ADN teológico y estratégico del proyecto), **(2)** los principios de imagen propios del barrio de Santa Eugenia, y **(3)** el ADN visual de las iglesias que el equipo ha tomado como referencia: **VIVE Church**, **Hillsong Madrid**, **Elan Church**, **121 BCN** y **Hechos Barcelona**.

### 10.0 El vocabulario LIDERE como fuente de identidad visual

Antes de hablar de colores y tipografías, la marca debe nacer del contenido. El curso LIDERE aporta un vocabulario, unos marcos y unas metáforas que deben impregnar toda la comunicación visual y verbal. Este es el "diccionario" interno del proyecto:
...
| **Valores** | Evangelismo por amistad, todos lideramos y servimos (*"ministramos por quiénes somos, no por los dones"*), relaciones saludables, excelencia, comunidad, servicio, generosidad. | El tono de la marca debe ser **horizontal** (no jerárquico), **relacional** (no institucional), y **excelente** (no cutre ni improvisado). |

#### Las 6C de la célula (Tema 2, Lección 2.2)
...
| **Crecemos** | Madurar en carácter y en aplicación de la Palabra. *"No enseñar a conocer, sino a guardar."* Discipulado en comunidad, no uno-a-uno aislado. Itinerario: Quién es Jesucristo → Fundamentos → Encuentro → LIDERE → Seminario Bíblico. | Metáfora del **crecimiento**: semilla, brote, raíz, árbol. *Brota*, *Semilla*, *Raíces*, *Crece*. La marca debe comunicar **proceso, no evento**. |
| **Cuidamos** | Especial cuidado de los nuevos convertidos. Nadie solo, en desamparo u olvidado. Acróstico **CAFÉ**: **C**ompartir + **A**mor + **F**e + **E**dificar. Regla de los 3 minutos. Derivar lo que no sabes. | La marca debe transmitir **seguridad y acogida**: oasis, refugio, casa. *Oasis*, *La Casa*, *Tu Lugar*. Si el nombre incluye "café", conecta directamente con el acróstico pastoral CAFÉ. |
| **Conquistamos** | Evangelismo relacional. *"Un grupo pequeño es un grupo de amigos con una misión."* Sin misión, la célula se desenfoca. Planificar la multiplicación. Orar por contactos. | La marca debe comunicar **movimiento y propósito**: avanzar, ir, conquistar. *YoVoy*, *Ven y Ve*, *Avanza*, *Multiplica*. |

#### Estructura de la reunión celular (Tema 2, Lección 2.1)

La reunión tiene **4 momentos**: Bienvenida (rompehielos) → Adoración (gratitud) → Palabra (diálogo, no enseñanza — somos facilitadores, no maestros) → Visión/Misión (meta práctica de la semana + oración).

**Implicación para la marca**: la experiencia del local debe reflejar estos 4 momentos. El nombre y la imagen deben sugerir un espacio donde se es **bienvenido** (no interrogado), donde hay **gratitud** (no queja), donde se **dialoga** (no se predica), y donde se sale con un **propósito** (no con las manos vacías).

#### Evangelismo relacional (Tema 3, Lecciones 3.1-3.2)

Tres tipos de evangelismo: **(1)** Relacional (familia, trabajo, amigos, vecinos), **(2)** de grupo (actividades evangelísticas de la célula), **(3)** de cosecha (invitación a la celebración general).

El evangelismo relacional es el motor: *"Come, celebra, toma un café, comparte actividades de ocio. Sé intencional."* La tabla de metas del temario organiza la vida relacional en: **Comidas / Fiestas / Ocio / Trabajo / CAFÉ** — planificando contactos semanales en cada área.
...
| *Local 4/13* | ✅ Sí | "Quedamos en el 4/13" — suena a dirección. |
| *ReCreando* | ✅ Sí | "¿Te vienes a ReCreando?" — suena a taller, a actividad. |
| *Buenas Noticias* | ⚠️ Regular | "¿Vienes a Buenas Noticias?" — suena a iglesia. |
| *Vida Nueva* | ❌ No | "¿Vienes a Vida Nueva?" — suena a rehabilitación. |

#### Multiplicación (Tema 4, Lección 4.3)

*"Reproducirnos en otro discípulo le llamamos multiplicación"* (2 Timoteo 2:2 — cuatro generaciones). La célula se multiplica cuando tiene: líderes preparados + hermanos bautizados formándose + nuevos creyentes + contactos/visitas.

**Implicación para la marca**: el nombre debe ser **replicable**. "Pura Vida Madrid" → "Pura Vida Barcelona". "Local 4/13" → "Local 7/21" (otro local, otra cita bíblica). "YoVoy Madrid" → "YoVoy Sevilla". Los nombres que son demasiado locales (*La Casa de Zazuar*) dificultan la multiplicación geográfica.
...
| **La sal, la luz, la levadura** | Mateo 5 — Sermón del Monte. *"La gente tiene que ver nuestras buenas obras"* | Faro, Lumbre, Alba, Oasis |
| **Amigos con una misión** | Temario 6C — *"Un grupo pequeño es un grupo de amigos con una misión"* | Entre Amigos, Ven y Ve, YoVoy |
| **Restaurar ruinas** | Isaías 61:4 — *"Restaurarán las ruinas antiguas"*. También: la iglesia como agente de transformación social. | Restaura, Renueva, Transforma |
| **Ven y ve** | Juan 1:46 / Juan 4 — la samaritana. Evangelismo de invitación, no de argumentación. | Ven y Ve (directamente del curso) |
| **El café** | Acróstico CAFÉ (Compartir, Amor, Fe, Edificar) — herramienta pastoral de primera línea. | Café Zazuar, El Café de Santa Eugenia |
| **Nueva vida** | Itinerario: "Quién es Jesucristo" → "Fundamentos de la Vida Cristiana" → Bautismo. *"He muerto para esta vida y renacido para una nueva."* | Vida Nueva, Pura Vida, Renueva |
...
| **Diversidad**: si hay personas, que reflejen la multiculturalidad del barrio. | **Caridad/asistencialismo**: no parecer un comedor social o una ONG. Es una comunidad de iguales. | Apocalipsis 7:9 — *"de toda nación, tribu, pueblo y lengua"*. La diversidad es la visión. |
| **Sencillez**: Hechos 2 — "sencillez de corazón". Nada recargado. | **Frialdad corporativa**: evitar el estilo franquicia importada. Debe sentirse del barrio. | *"No es que la iglesia de Dios tenga una misión, sino que la misión de Dios tiene una iglesia"* — lo local importa. |
| **Movimiento**: la marca debe comunicar que algo PASA aquí, que hay vida, que esto avanza. | **Estancamiento**: nada que sugiera "ya llegamos" o "esto es lo que hay". | *"La meta de la célula es la misión"* — la comunión es fruto, no fin. Siempre hay un siguiente paso. |

### 10.2 ADN visual de las iglesias de referencia
...
| **Tono** | Directo, emocional, aspiracional: *"Bienvenido a Casa"*, *"¿Listo para una transformación real?"*, *"A Church for Barcelona"*, *"Despertando a las personas a la realidad de Jesús"*. |
| **Naming** | Nombres cortos (1-2 palabras), español o bilingüe, sin referencia religiosa explícita. "Church" o "iglesia" aparece como descriptor, no como nombre central. |
| **Branding** | Logo minimalista (lettering puro o símbolo abstracto). Funciona en blanco y en color. Muy adaptable a Stories, reels, merch. |
...
| **Acento vibrante 2** | Naranja cálido | #E8732A | Vallecas, cercanía, energía | **Celebramos** (6C): fiesta, cumpleaños, gratitud. Calidez relacional |
| **Acento vibrante 3** | Morado eléctrico | #8E44AD | VIVE Church, YoVoy | **Conquistamos** (6C): movimiento, misión, ir (Mt 28 — "yendo") |
| **Identidad local** | Terracota / ladrillo | #C44D2F | Como el ladrillo de Vallecas | **Conectamos con la comunidad** (6C): encarnación en el barrio |
| **Confianza** | Azul profundo | #2E6B8A | Estabilidad, seriedad accesible | **Compartimos la Palabra** (6C): la Biblia como guía, roca no arena (Joel Comiskey cap. 1) |
| **Dorado/esperanza** | Amarillo dorado | #F1C40F | Hillsong, Local 4/13, Alba | **Visión**: Ap 7:9 — la multitud adorando. Gloria, cielo, esperanza |
| **Neutro texto** | Blanco roto | #FAF8F5 | Legibilidad sobre fondos oscuros | **Sencillez** (valor LIDERE): limpio, sin ruido, sencillez de corazón |

*Nota: No es necesario usar todos los colores. Cada nombre tiene su paleta natural. La tabla es un menú. Lo que sí es necesario es que la paleta elegida pueda "contarse" con el vocabulario LIDERE.*
...
| **Eslóganes / handwriting** | Caveat / Kalam / Satisfy | Manuscrita, cercana. Para claims emocionales. |
| **Estilo urbano** | Sora Bold / Oswald | Geométrica, directa. Para Local 4/13, Zazuar 13, YoVoy. |

### 10.6 Aplicaciones clave

Cada aplicación debe reflejar el modelo LIDERE: la vida compartida, el evangelismo relacional, la sencillez y la misión.

1. **Cartel de fachada**: nombre grande + eslogan + horarios. Estilo galería o cafetería, no templo. Iluminación cálida tipo Edison o neón sutil. *Conexión LIDERE*: el cartel debe invitar como invita un amigo — sin presión, con calidez. El test: ¿un vecino no creyente se pararía a mirar?
2. **Web / landing page**: hero image a pantalla completa (gente real del barrio, no stock), nombre en tipografía bold, eslogan debajo, botón de acción ("Ven este domingo" / "Descubre más"). *Conexión LIDERE*: la web es el equivalente digital de la "Bienvenida" de la reunión celular — rompehielos, cero barreras.
3. **Instagram**: logo como foto de perfil. Feed curado con fotos luminosas, frases cortas, reels de momentos de comunidad. *Conexión LIDERE*: cada publicación es evangelismo relacional digital. Compartir la vida (6C — Compartimos), no solo programar eventos.
4. **Flyer de buzón**: "¿Conoces [nombre]? Pásate este [día] a las [hora]." Diseño limpio, no recargado. *Conexión LIDERE*: la tabla de metas de evangelismo relacional (Lección 3.1) incluye planificar contactos con vecinos. El flyer es una herramienta para esa tabla.
...
## 11. RANKING FINAL UNIFICADO: TOP 15

Evaluados según **seis criterios** ponderados. Los cinco primeros al 16% cada uno y el sexto (LIDERE) al 20%, reflejando que la coherencia con el ADN del curso es la columna vertebral del proyecto:

1. **Atractivo para el barrio** (16%) — ¿Un vecino de Santa Eugenia que no conoce a Dios entraría?
2. **Fidelidad a la visión LIDERE** (20%) — ¿Refleja el evangelismo relacional, las 6C, la vida en las casas, la sencillez de Hechos 2 y la reproducción de discípulos?
...
| **Meet Madrid** | **Conectamos** (6C) — cuatro niveles de conexión. Pero la barrera idiomática es alta para el barrio. | Potente para público internacional, pero demasiado anglófono para Santa Eugenia. Reservar para segundo local en zona céntrica. |
| **Buenas Noticias SE** | **Misión** — "Evangelio" = εὐαγγέλιον = buenas noticias. Coherencia con la iglesia madre. | Contracultural en un barrio donde las noticias suelen ser malas. |
